        ...
        <div className="grid grid-cols-3 gap-2.5 mb-4">
          {['1','2','3','4','5','6','7','8','9'].map(d => (
            <button
              ...
              className="bg-white/10 hover:bg-white/20 active:bg-[#7AC142] active:text-[#0B3B68] text-white font-black text-xl py-4 rounded-2xl transition-all active:scale-95 border border-white/5"
            >
              {d}
            </button>
          ))}
          ...
          <button
            ...
            className="bg-white/10 hover:bg-red-500/30 active:bg-red-500 text-white py-4 rounded-2xl transition-all active:scale-95 border border-white/5 flex items-center justify-center"
          >
            <Delete size={20} />
          </button>
        </div>
